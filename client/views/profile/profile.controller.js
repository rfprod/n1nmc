...
angular.module('appCore.profile', ['ui.bootstrap.modal'])

	.controller('ProfileController', ['$rootScope', '$scope', '$state', '$uibModal', 'UserService', 'API', 'usSpinnerService',

		function($rootScope, $scope, $state, $uibModal, UserService, API, usSpinnerService){
